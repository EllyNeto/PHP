...
<div class="app">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav id="nav">
      ...
      <a href="{{ url('/admin/dashboard') }}" class="nav-item {{ $active === 'visao' ? 'active' : '' }}">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="9" rx="1.5"/><rect x="14" y="3" width="7" height="5" rx="1.5"/><rect x="14" y="12" width="7" height="9" rx="1.5"/><rect x="3" y="16" width="7" height="5" rx="1.5"/></svg>
        Visão Geral
      </a>
      <a href="{{ url('/admin/formandos') }}" class="nav-item {{ $active === 'formandos' ? 'active' : '' }}">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
        Formandos
      </a>
      <a href="{{ url('/admin/cursos-turmas') }}" class="nav-item {{ $active === 'formadores' ? 'active' : '' }}">
      ...
      <a href="{{ url('/admin/matriculas') }}" class="nav-item {{ $active === 'matriculas' ? 'active' : '' }}">
      ...
      <a href="{{ url('/admin/certificacoes') }}" class="nav-item {{ $active === 'certificacoes' ? 'active' : '' }}">
      ...
      <a href="{{ url('/admin/relatorios') }}" class="nav-item {{ $active === 'relatorios' ? 'active' : '' }}">
      ...
      <a href="{{ url('/admin/definicoes') }}" class="nav-item {{ $active === 'definicoes' ? 'active' : '' }}">
...
<div class="overlay" id="overlay">
  <div class="modal">
    ...
    <form method="POST" action="{{ url('/admin/matriculas') }}">
      @csrf
      <div class="field">
